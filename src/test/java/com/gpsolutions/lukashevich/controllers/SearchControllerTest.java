...
class SearchControllerTest {
    ...
    void search_noParams_shouldReturnAllHotels() throws Exception {
        ...
        when(searchService.searchHotels(isNull(), isNull(), isNull(), isNull(), isNull()))
    ...
    void search_withCityParam_shouldReturnFilteredHotels() throws Exception {
        ...
        when(searchService.searchHotels(isNull(), isNull(), eq("Minsk"), isNull(), isNull()))
                .thenReturn(expectedHotels);
    ...
    void search_withMultipleParams_shouldReturnFilteredHotels() throws Exception {
        ...
        when(searchService.searchHotels(eq("Hotel 1"), eq("Hilton"), eq("Minsk"), eq("Belarus"), eq("Free WiFi")))
                .thenReturn(expectedHotels);
    ...
    void search_noMatchingHotels_shouldReturnEmptyList() throws Exception {
        when(searchService.searchHotels(anyString(), anyString(), anyString(), anyString(), anyString()))
